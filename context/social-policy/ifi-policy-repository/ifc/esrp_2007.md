...
[IFC ESRPs](www.ifc.org/esrp) set out detailed instructions for project environmental and social due diligence, monitoring and supervision. ESRP are organized according to the stages of the investment (scoping, screening, appraisal, disclosure of investment commitments, and supervision). The ESRP distinguish between direct investments, financial intermediary investments, and advisory services.



## Environmental and Social Review Procedures (July 2007) [[PDF](http://www.ifc.org/wps/wcm/connect/90319500488559a3839cd36a6515bb18/ESRP2007.pdf?MOD=AJPERES)]
...
Approval;<br />
b. Input for the drafting of legal agreements; and<br />
...
4.2.16
Prepare the ESCM: <br />
a. For Category B projects as per Annex 4.5.6 and obtain clearance in iDesk from the Team Leader and copy the Manager CESIG; <br />
b. For Category A projects as per Annex 4.5.6. in coordination with the Team Leader, and submit to the Manager CESIG for approval before the project is submitted for Board/Management consideration; <br />
c. In cases where BCS is required, include in the ESCM the recommendations
on the status of BCS and the decision that has been taken; and <br />
...
4.2.17
Prepare S&E wording for the Board Paper: <br />  
a. The E&S section of the Board Paper should describe the significant impacts and mitigations. Provide support, as necessary, to the project team for project presentations and briefings to the Board; <br />
b. In cases where BCS is required, the Board Paper should include the recommendations on the status of BCS and the decision that has been taken; and <br />
c. Include E&S additionality language where warranted. See annex 4.5.7 for guidance.
...
6.1.1
This procedure describes the S&E review process during the supervision stage of the IFC project cycle for Direct Investment projects. It covers the period from first disbursement until the project is closed as an IFC investment. Supervision covers the following steps:<br />
&emsp;a. Ensuring that any S&E CODs are met by the client prior to the disbursement;<br />
&emsp;b. Conducting ongoing review of the S&E performance of the investment as per the conditions of the legal agreements, including:<br />
&emsp;&emsp;b.1 Review of the AMR;<br />
&emsp;&emsp;b.2 On-site supervision visits to review project performance;<br />
&emsp;&emsp;b.3 Support to the Transaction Leader in responding to information or client notification of any serious incident or fatality related to the project;<br />
&emsp;&emsp;b.4 Review of the client’s implementation of the Action Plan including any Supplemental Actions;<br />
&emsp;&emsp;b.5 Review of the client’s S&E compliance, including public consultation, disclosure and monitoring requirements;<br />
&emsp;&emsp;b.6 Review of the project’s performance with reference to the project performance indicators and Monitorable Impacts; and <br />
&emsp;&emsp;b.7 Generation of Environmental and Social Risk Rating (ESRR). <br />
&emsp;c. Responding to any inquiries and complaints or requests for information; <br />
&emsp;d. Providing inputs to Project Supervision Reports (PSRs) and Expanded Project Supervision Reports (XPSRs); <br />
&emsp;e. Supporting CAO and IEG in the implementation of its work; and <br />
&emsp;f. Responding to shortfalls in project performance. <br />
...
Scenarios for waiving supervision could include:<br />
&emsp;a. Where there is a dispute but it is considered temporary and resolvable by the Transaction Leader the project supervision may be considered for postponement; and<br />
&emsp;b. Where the dispute is considered either permanent or irresolvable, the project supervision activities may be considered for postponement, suspension or termination.
...
6.2.4
For all AMRs, ensure the following:<br />
&emsp;a. There is an AMR cover sheet produced by the ACS staff;<br />
&emsp;b. The information provided is adequate. If not, request additional information from the client through the Portfolio Officer. (The ACS staff will log AMR follow up information in iDesk); and<br />
&emsp;c. The report has been submitted according to the timeframes specified in the legal agreement. If the report has been submitted late, ask the Transaction Leader to communicate the need for timely reporting to the client.

6.2.5
For portfolio projects reviewed under the WBG Safeguard Policies which preceded the PS, follow the steps below using the AMR review template in iDocs and the ESRR worksheet in the CES workspace instead of the ESRD. Review the AMR, focusing on:<br />
&emsp;a. The client’s performance against the requirements of the investment agreement in particular and the applicable WBG Policies in general;<br />
&emsp;b. The status of the client’s implementation of the S&E Action Plan;<br />
&emsp;c. Key steps the client may need to take to improve its performance;<br />
&emsp;d. Previous AMR reviews and ESRR scores;<br />
&emsp;e. Serious incidents to confirm whether they were reported in accordance with the legal agreements and to determine whether a consistent pattern emerges and follow up action is required with the client; and<br />
&emsp;f. Recommendations that may have been made by CAO and the status of their implementation as per Procedure 6.2.16.

6.2.6
For portfolio projects reviewed under the PSs, review the AMR and record in the ESRD the following information:
&emsp;a. The client’s performance against the requirements of the investment agreement in particular and the IFC PS in general;<br />
&emsp;b. The status of the client’s implementation of the Action Plan, including any Supplemental Actions;<br />
&emsp;c. The status of the client’s SEMS;<br />
&emsp;d. The status of the client’s community engagement process, including ongoing local disclosure of the Action Plan progress, consultation and any participatory monitoring or reporting obligations;<br />
&emsp;e. The status of performance, based on the performance indicators as determined in Procedure 3.4.2e;<br />
&emsp;f. Key performance gaps relating to the client’s performance, the Action Plan including Supplemental Actions, or SEMS;<br />
&emsp;g. Key steps the client may need to take to improve its performance;<br />
&emsp;h. Previous AMR reviews and ESRR scores;<br />
&emsp;i. Serious incidents to confirm whether they were reported in accordance with the legal agreements and to determine whether a consistent pattern emerges and follow up action is required with the client; and<br />
&emsp;j. Recommendations that may have been made by CAO and the status of their implementation as per Procedure 6.2.16. 
...
6.2.13
Determine the need for a supervision site visit based on the ESRR score and the following minimum criteria:
...
&emsp;a. Cooperate with the CAO staff;<br />
&emsp;b. Communicate the process to the Transaction Leader and the client and keep the client informed of the CAO’s investigation; <br />
&emsp;c. Once the CAO has drafted a report, ask the Transaction Leader to coordinate with the project team and the client to review the report for accuracy, and to provide further information to the CAO as needed;<br />
&emsp;d. Submit the draft response and comments to the Manager CESIG for review, before it is submitted to the CAO and document this process in the ESRD;<br />
&emsp;e. The Transaction Leader should ask the CAO’s office to post the IFC project team’s response to the CAO’s draft report on the CAO’s Web site; and<br />
&emsp;f. The Lead Specialist should record the CAO recommendations and the implementation plan in the ESRD. 

**6.3 Responsibilities**

6.3.1
The Transaction Leader is responsible for:<br />
&emsp;a. Informing the Lead Specialist of any S&E CODs not complied with.

6.3.2
The Lead Specialist is responsible for:<br />
&emsp;a. Providing clearance on S&E CODs;<br />
&emsp;b. Seeking approval from the Manager CESIG to waive CODs or to add new CODs;<br />
&emsp;c. Reviewing the AMR to determine S&E performance and documenting this in ESRD;<br />
&emsp;d. Providing PSR and XPSR S&E wording to the Portfolio Officer;<br />
&emsp;e. Conducting site visits or retaining a consultant to conduct these on IFC’s behalf and update the ESRR score based on findings from the site visits;<br />
&emsp;f. Notifying the Portfolio Officer, consulting with the Manager CESIG and making a recommendation to the Director of CES and the Director Investment Department (and where applicable Regional Director) in relation to action required in response to exceptional circumstances (paragraph 6.2.7);<br />
&emsp;g. Notifying the Manager CESIG of major incidents;<br />
&emsp;h. Notifying the Manager CESIG of complaints accepted by the CAO; and<br />
&emsp;i. Providing input to the Portfolio Officer for responses to complaints accepted by the CAO.<br />

6.3.3
ACS staff is responsible for:<br />
&emsp;a. Logging the AMRs in iDesk, producing the AMR cover sheet and distributing it to the Lead Specialist;<br />
&emsp;b. Updating ESRR score in iDesk and CRD after AMR review completion;<br />
&emsp;c. Updating the AMR review management field in iDesk;<br />
&emsp;d. Updating AMR follow up field in iDesk;<br />
&emsp;e. Entering Supervision data into iDesk;<br />
&emsp;f. Distributing AMR review to Portfolio Officer, Portfolio Assistant and Team Leader; and<br />
&emsp;g. Documenting in the ESRD reasons for waiving supervision. 


6.3.4
The Team Leader is responsible for:<br />
&emsp;a. Interacting with the Portfolio Manager to determine a supervision plan; and<br />

6.3.5
The Manager CESIG is responsible for:<br />
&emsp;a. Clearing waiver of S&E CODs;<br />
&emsp;b. Clearing any new COD’s not in the original documents;<br />
&emsp;c. Making recommendation to the Director of CES and the Director InvestmentvDepartment (and where applicable Regional Director) in relation to action required in response to exceptional circumstances (paragraph 6.2.7); and<br />
&emsp;d. Reviewing CES input for responses to CAO investigations.<br />

6.3.6
The AS officer is responsible for:<br />
&emsp;a. N/A.

6.3.7
The Manager of AS is responsible for:<br />
&emsp;a. N/A.

6.3.8
All AS DFOs and Departments are responsible for:<br />
&emsp;a. N/A.

6.3.9
The Portfolio Officer is responsible for:<br />
&emsp;a. Requesting from the client, obtaining, and providing the AMR to the Lead Specialist;<br />
&emsp;b. Communicating to the client any data deficiencies and/or Supplemental Actions identified by the Lead Specialist;<br />
&emsp;c. Requesting and incorporating S&E wording into the PSR and XPSR;<br />
&emsp;d. Notifying the Lead Specialist, the Manager of the Investment Department and Corporate Relations, as needed, of any incidents;
&emsp;e. Notifying the client when the CAO has accepted a complaint;<br />
&emsp;f. Coordinating a project team response to a CAO complaint; and<br />
&emsp;g. Notifying the Lead Specialist if there is a change in the status of the legal agreement, including loan prepayment, assignment or sale of the loan to another party, or change in equity ownership.

6.3.10
The Portfolio Manager is responsible for:<br />
&emsp;a. Interacting with the Team Leader to determine a supervision plan; and<br />
&emsp;b. Documenting in the Compliance Tracking System remark section reason for waving supervision.

6.3.11
The Director CES is responsible for:<br />
&emsp;a. Making a determination, in conjunction with the Director Investment Department (and where applicable Regional Director) if a disclosure should be made because of an exceptional circumstance. 


6.3.12
The Director Investment Department (and where applicable Regional Director) is responsible for:<br />
&emsp;a. Making a determination, in conjunction with the Director CES, if a disclosure should be made because of an exceptional circumstance.

6.3.13
The VP Industry is responsible for:<br />
&emsp;a. N/A.
...
6.4.3
Where conducted, submit the site visit BTO in ESRD copying project file in iDocs.
