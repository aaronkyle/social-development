...
Free, Prior and Informed Consent [Consultation] (FPIC): a participatory, community-approach to development that is designed to secure the rights of indigenous peoples and local communities, including the right to self-determination and to control of land and natural resources.  FPIC is typically achieved by giving local people a formal role (and some form of veto power) in the consultations and decision-making about local development projects.
