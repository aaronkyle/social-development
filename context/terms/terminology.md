...
<head>
    <meta charset="utf-8">
    <title>Social Development: Policy & Practice.: Category: terminology</title>
    <meta itemprop="image" content="http://applied-anthro.com/images/favicon-128x128.png">
    <link rel="shortcut icon" href="http://applied-anthro.com/favicon.ico">
    <link rel="apple-touch-icon-precomposed" href="./images/apple-touch-icon.png">

    <meta name="description" itemprop="description" content="All the content on Social Development: Policy & Practice. in the terminology category." />
...
-->
    ...
    <link rel="stylesheet" media="all" href="http://applied-anthro.com/theme/webassets-external/abab6eb799f34b5ef04061e2fd5265c7_pygments-monokai.css">
        ...
        <div class="container">
            <div class="row-fluid">
                ...
                <div class="social span2" id="socialist">
                    <h4 class="nav-header">Social</h4>
                    <ul class="nav nav-list">
                        <li><a href="https://www.linkedin.com/in/akdennis" rel="author"><i class="icon-linkedin-squared"></i>LinkedIn</a></li>
                ...
                <div class="links span2">
                    ...
                    <ul class="nav nav-list">
                        <li><a href="http://aaron-kyle.com/" rel="author"><i class="icon-user"></i>CV/Resume</a></li>
                    </ul>
                </div>
            ...
            <p>
                <small>
                    Written and maintained by <a href="../site/bio/">Aaron Kyle Dennis</a> &copy; 2004-2016 <br />
                    Powered by <a href="http://github.com/getpelican/pelican">Pelican</a> and
                    <a href="https://twitter.github.com/bootstrap">Twitter Bootstrap</a>.
                    Template by <a href="http://duncanlock.net/pages/duncan-locks-resume.html">Duncan Locke</a>.
