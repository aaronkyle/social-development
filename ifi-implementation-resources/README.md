...
This [repository](https://github.com/aaronkyle/social-development/tree/master/ifi-implementation-resources) collects informational resources produced by financial institutions.

* [`implementation-resources_adb`](./implementation-resources_adb.md) <!--\*-->
* [`implementation-resources_ifc`](./implementation-resources_ifc.md)
* [`implementation-resources_world_bank`](./implementation-resources_world-bank.md) <!--\*-->
