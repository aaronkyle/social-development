...
The prefix 'meta' took on the popular meaning of 'on higher level of abstraction'. A grammar book in linguistics is a good example of this usage, as it addresses the rules of language on a higher level in order to describe properties of that language (and not itself).[[1]](# "due in large part to the 1979 book by Douglas Hofstadter, *Gödel, Escher, Bach* (and in the sequel, Metamagical Themas").
